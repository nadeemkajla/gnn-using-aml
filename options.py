...
class Options():
    ...
    def __init__(self):
        ...
        parser.add_argument('dataset', type=str, choices=['letters', 'histograph', 'histographretrieval','GREC', 'Comic'],
                            help='Choose between letters.')
        # Model parameters
        parser.add_argument('--nlayers', type=int, default=2, help='Message passing + Update layers.')
        parser.add_argument('--distance', type=str, default='Heomd', help='Graph distance used.', choices=['Heomd', 'Hd', 'SoftHd'])
        ...
        parser.add_argument('--epochs', '-e', type=int, default=2000, help='Number of epochs to train.')
